...
|---------|-------------|
| [AI Job Agent](https://github.com/AkbarDevop/ai-job-agent) | Open source toolkit that automated 200+ job applications across 5 ATS platforms, LinkedIn networking, and international outreach |
| [PAAL Pipeline](https://github.com/AkbarDevop/paal-pipeline) | Precision livestock monitoring using OAK-D depth cameras — RGB, IR, and depth CV with **98.4% accuracy** on edge-deployable models |
| [Aristotle Canvas Assistant](https://github.com/AkbarDevop/aristotle-canvas-assistant) | Terminal-first Canvas LMS copilot that syncs assignments to Google Calendar, Notion, Todoist, and Trello |
| [Ayah Studio](https://github.com/AkbarDevop/ayah-studio) | Quran recitation subtitle editor with timeline controls and audio sync — Next.js 16, React 19 |
| [Ask Paiziev24](https://askpaiziev24.netlify.app/) | Multilingual AI clone of entrepreneur Akmal Paiziev, grounded in real interviews and public writings |
| [Whoop Insights](https://github.com/AkbarDevop/whoop-insights) | Privacy-first fitness dashboard combining WHOOP, Strong, and Apple Health data in the browser |
| [Unicraft](https://unicraft.uz) | Mentorship platform connecting university applicants with successful students |
...
- Founded the **[Mizzou Claude Builders Club](https://github.com/AkbarDevop/mizzou-cbc)** — first Claude Code community at a university
- Published research on **sow posture classification** using multi-modal depth sensing (98.4% accuracy)
- Open sourced an **[Uzbekistan Tech Ecosystem Guide](https://github.com/AkbarDevop/ai-job-agent/blob/main/uzbekistan-tech-ecosystem-guide-2026.md)** — startups, government AI initiatives, tax-free zones, and engineering opportunities
